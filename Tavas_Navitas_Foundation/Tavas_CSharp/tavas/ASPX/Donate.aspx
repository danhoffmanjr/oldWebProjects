...
<body>
    <form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post" runat="server">
        ...
        <input type="hidden" name="amount_1" value="10.00" id="hdnAmt" >
        ...
        <div class="midContent">
            <div class="page">
                <div class="content">
                    ...
                    <div  class="divCover">
                    <p> Donate Now<br />
                    Thank you for considering making a donation to Tavas. We appreciate your generosity, which will help us more closer to our vision of seeing go Green.
                    </p>
                    <asp:TextBox ID="txtAmount" runat="server"></asp:TextBox>
                    </div>
                     <div class="divCover" >
                      <input type="submit" name="submit" value="Submit" onclick="Sent();" >
                     </div>
                    </asp:Panel>
